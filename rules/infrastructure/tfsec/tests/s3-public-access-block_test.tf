# Test fixtures for KIRBY-INF-005 / EEDOM-AWS-004 — S3 Public Access Block
...
# FAIL: block_public_acls is false — partial configuration does not satisfy EEDOM-AWS-004
...
resource "aws_s3_bucket_public_access_block" "fail_missing_restrict" {
  ...
  block_public_policy = true
  ignore_public_acls  = true
  # restrict_public_buckets omitted — defaults to false, fails EEDOM-AWS-004
}
